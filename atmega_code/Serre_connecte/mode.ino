...
void average_day(){
    ...
    if (current_sample_day<total_samples_day){
        ...
        day_humidity_greenhouse[rotate_day_index]= current_average_humidity_greenhouse;
        ...
        day_humidity_out[rotate_day_index]= current_average_humidity_out;
      ...
      for(int i=0;i<NUMBER_SAMPLES_DAY;i++){
       ...
       Serial.println(average_humidity_out);*/
